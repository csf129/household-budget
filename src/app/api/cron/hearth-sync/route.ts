...
export async function GET(req: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      categorized,
      as_of: rollup.as_of,
      week: { budget: rollup.week.budget, spent: rollup.week.spent, income: rollup.week.income },
      month: { budget: rollup.month.budget, spent: rollup.month.spent, income: rollup.month.income },
